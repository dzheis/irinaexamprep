...
const sideCertificates = [
  { id: 1, src: '/placeholder-certificate.svg', alt: 'Сертификат CELTA' },
  { id: 2, src: '/placeholder-certificate.svg', alt: 'Сертификат DELTA' },
  { id: 3, src: '/placeholder-certificate.svg', alt: 'Сертификат Cambridge' },
];

const bottomCertificates = [
  { id: 4, src: '/placeholder-certificate.svg', alt: 'Сертификат IELTS Expert' },
  { id: 5, src: '/placeholder-certificate.svg', alt: 'Сертификат TOEFL Trainer' },
  { id: 6, src: '/placeholder-certificate.svg', alt: 'Сертификат CPE' },
  { id: 7, src: '/placeholder-certificate.svg', alt: 'Сертификат TKT' },
];
...
export default function AboutSection() {
  ...
  return (
    <AnimatedSection id="about" animationDirection="up">
      <div className="card relative overflow-hidden transition-[transform,box-shadow] duration-300 ease-in-out shadow-[0_8px_16px_rgba(47,52,64,0.08),0_20px_40px_rgba(47,52,64,0.08),0_24px_60px_rgba(47,52,64,0.06)] hover:shadow-[0_12px_24px_rgba(47,52,64,0.1),0_28px_56px_rgba(47,52,64,0.1),0_32px_72px_rgba(47,52,64,0.08)] hover:scale-[1.01]">
        {/* Background photo */}
        <div className="absolute inset-0 z-0">
          <Image
            src="/irina_petrova_about.JPG"
            alt="Ирина Петрова"
            fill
        ...
        <div className="relative z-10 flex flex-col gap-6 min-h-0 flex-1">
          ...
          <div className="flex flex-col lg:flex-row gap-8 justify-between min-h-0 flex-1">
            ...
            <div className="w-full max-w-full min-[640px]:max-w-[50%] lg:w-1/2 lg:max-w-none lg:pr-4 min-h-0 flex flex-col">
              ...
              <div className="prose prose-lg max-w-none leading-relaxed text-white min-h-0 overflow-visible text-left [&_p]:text-justify">
                ...
                <p className="text-lg md:text-xl text-justify indent-8">
            ...
            {/* Right side: certificates vertical stack - aligned to right (150% превью) */}
          ...
          {/* Bottom certificates - horizontal row */}
